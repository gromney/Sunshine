...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:{
                rowUpdate = db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            case LOCATION: {
                rowUpdate = db.update(WeatherContract.LocationEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
